...
class CardComponentView(context: Context, attrs: AttributeSet) :
    ...
    private fun init(context: Context, attrs: AttributeSet) {
        ...
        val view = inflate(
            context,
            R.layout.base_card_component_view_element,
            this
        )
        binding = BaseCardComponentViewElementBinding.bind(view)

 /*       CoroutineScope(Dispatchers.IO).launch {
            when (userRepository.getTheme()) {
                LIGHT_MODE -> {binding.cardParentCardLayout.setBackgroundResource(R.drawable.rounded_borders_solid)}
                DARK_MODE -> {}
                DEVICE_MODE -> {}
            }
        }*/

        val attributes = context.obtainStyledAttributes(attrs, R.styleable.CardComponentView)
        val iconColorResource: Int = attributes.getColor(
            R.styleable.CardComponentView_card_icon_color,
            ContextCompat.getColor(context, com.google.android.material.R.color.accent_material_dark)
        )
        ...
        val isTagHidden: Boolean =
            attributes.getBoolean(R.styleable.CardComponentView_card_hide_tag, true)

        val isCardInactive: Boolean =
            attributes.getBoolean(R.styleable.CardComponentView_card_inactive, false)
        ...
        val titleText: String =
            attributes.getString(R.styleable.CardComponentView_card_title_text) ?: ""
        val subTitleText: String =
            attributes.getString(R.styleable.CardComponentView_card_subtitle_text) ?: ""

        val descriptionText: String =
            attributes.getString(R.styleable.CardComponentView_card_description_text) ?: ""

        val tagText: String? =
            attributes.getString(
                R.styleable.CardComponentView_card_tag_text
            )
